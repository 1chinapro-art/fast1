...
import { Send, Zap, Clock, DollarSign, CheckCircle2, ArrowRight, Play, Sparkles, Rocket, Palette, Star, TrendingUp } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto px-6 text-center relative">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-6">
                <a 
                  href={telegramLink}
                  className="cta-button bg-white text-slate-950 hover:bg-neon-green transition-colors px-8 sm:px-12 py-4 sm:py-5 text-lg sm:text-xl font-black uppercase tracking-widest w-full sm:w-auto"
                >
                  Запустити проєкт
                  <Rocket size={24} />
                </a>
        ...
        <footer className="py-20 sm:py-32 bg-slate-950 border-t border-white/5 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <a 
                href={telegramLink}
                className="cta-button bg-neon-green text-slate-950 neon-shadow inline-flex px-10 sm:px-16 py-5 sm:py-7 text-xl sm:text-2xl font-black uppercase tracking-[0.2em] mb-16 sm:mb-24 w-full sm:w-auto"
              >
                Написати в Telegram
              </a>
            </motion.div>
